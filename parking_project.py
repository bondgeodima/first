...
# Video derectory of the project
VIDEO_DIR = os.path.join(ROOT_DIR, "car_video")
...
IMAGE_DIR = os.path.join(ROOT_DIR, "car_video/image")
...
while True:
    ...
    for box in car_boxes:
        ...
        # Draw the box
        cv2.rectangle(resized, (x1, y1), (x2, y2), (0, 255, 0), 1)
